    ...
    return (
        <header className={styles.header}>
            ...
            <Link href='/' className={styles.hero}>
                <Image priority src={profileImage} alt='Profile picture' height={70} width={70}  className={styles['hero-img']}/>
                ...
                <ul className={styles['nav-bar-items']}>
                    ...
                    <li>
                        <Link href='https://github.com/bouvet-ofykse' target='_blank'>
                            <Image priority src={githubIcon.src} width={24} height={24} alt='GitHub icon'
