...
export default function NavBar() {
    ...
    return (
        <header className='pt-16 px-16'>
            ...
            <Link href='/' className='text-3xl flex flex-row gap-4 items-center'>
            ...
            <nav>
                <ul className='flex flex-row gap-7 justify-end'>
                    ...
                    <li><Link href='/image-analysis' className='dark:hover:bg-blue-900 p-2 rounded'>
                        Image
                        analysis</Link>
                    </li>
                    <li><Link href='/memory-game' className='dark:hover:bg-blue-900 p-2 rounded'>Emoji Memory</Link></li>
